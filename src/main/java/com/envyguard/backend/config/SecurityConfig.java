...
import com.envyguard.backend.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    /**
     * Ignores security filters for certain paths.
     * This completely bypasses Spring Security for these endpoints.
     */
    @Bean
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of(
                "https://envyguard.andrescortes.dev",
                "https://api.andrescortes.dev",
                "http://localhost:3000",
                "http://localhost:8080"));
